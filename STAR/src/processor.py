...
class processor(object):
    ...
    def train_epoch(self, epoch):
        ...
        for batch in range(self.dataloader.trainbatchnums):
            ...
            # print('batch_abs:', batch_abs[:-1].shape)
            # print('batch_norm:', batch_norm[:-1].shape)
            # print('shift_value:', shift_value[:-1].shape)
            # print('seq_list:', seq_list[:-1].shape)
            # print('nei_list:', nei_list[:-1].shape)
            # print('nei_num:', nei_num[:-1].shape)
            # print('batch_pednum:', batch_pednum[:-1].shape)
